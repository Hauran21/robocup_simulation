...
def generate_launch_description():
    ...
    model_path = str(Path(awdbot_description).parent.resolve())
    model_path += pathsep + os.path.join(get_package_share_directory("awdbot_description"), 'models')
